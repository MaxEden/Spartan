...
//        var _defaultArea = new Rect(0, 0, _defaultSize.X, _defaultSize.Y);

//        Layout.Start(_defaultArea, Input);
...
//        {
//            var col1 = new SColor(color.r, color.g, color.b, color.a);
//            var col2 = new SColor(color2.r, color2.g, color2.b, color2.a);
...
//        //DrawRectRaw(area, Color32.green);
...
//        //view.Center = new Vector2f(area.X + area.Width*0.5f, area.Y + area.Height * 0.5f);
...
//       //Layout.CurrentArea = new Rect(area.X, area.Y - shift, area.Width, Height);
